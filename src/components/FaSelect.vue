<template>
    <div
        ...
        @click="onClick"
    >
        <div class="falco-select-result" :class="{ disabled: disabled }">
            <span class="falco-select-result-content">{{ selectedLabel }}</span>
            <i class="falco-select-clear" @click="clear" v-show="!disabled"></i>
        </div>
        <div
            v-show="open"
            class="falco-select-menu"
            :class="{ above: position === 'up', below: position === 'down' }"
        >
            <div class="falco-select-menu-header"></div>
            <ul class="falco-select-menu-body">
                <li
                    v-for="option in options"
                    :key="option.value"
                    value="option.value"
                    class="falco-select-menu-item"
